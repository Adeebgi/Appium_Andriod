...
public class eCommerce_TC_3 extends BaseTest {
	...
	//context name might change based on developer, you need to ask developber
	//could you give the context of hybrid/
	//remember to test any operation in Chrome Browser, You require chrome driver
	//check version of Chrome Browser on emulator then download the same version 
